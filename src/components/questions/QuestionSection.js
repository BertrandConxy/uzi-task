    ...
    <section className='section-bg-2 py-3'>
        <div className='d-flex justify-content-between'>
            ...
            <div class="form-check form-switch d-flex flex-column ">
                <label class="form-check-label fw-bold my-2 text-white" for="flexSwitchCheckChecked">Music</label>
                <input class="form-check-input m-0" type="checkbox" id="flexSwitchCheckChecked"></input>
            </div>
